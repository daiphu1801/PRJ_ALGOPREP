...
| **Đợt** | `batch` | Nhóm testcase trong một bài nộp, xử lý theo thứ tự. **Không còn là đơn vị gửi cùng lúc sang engine** — F4 gọi `JudgeExecutionPort` từng testcase một (`DEC-2026-0823-go-judge-default-engine`); "đợt" giờ chỉ còn là khái niệm nhóm/thứ tự xử lý, không phải hình dạng request. Sửa 2026-09-09: bỏ chữ "với fail-fast" — `F4-04` hết hiệu lực theo `DEC-2026-0831-partial-score-testcase-ratio`, thứ tự xử lý không còn quyết định testcase nào bị bỏ vì không testcase nào bị bỏ | "chunk", "group" |
