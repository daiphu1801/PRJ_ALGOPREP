...
> [SoT: 01-rd/overview/system_survey.md — mục 7.1 dòng `solution_review`]. Bounded Context: `ai-review` (F5.1)
...
[SoT: 01-rd/req/user_stories/a1_student.md — `US-A1-06`; 01-rd/overview/system_survey.md — mục 7.1 dòng `solution_review`].
...
- `01-rd/overview/system_survey.md` — mục 7.1 dòng `solution_review`.
