...
> **Phát hiện của Phase 2, đã tự chốt 2026-08-25 — xem mục 5**: `identity.md` ban đầu chỉ chốt "sửa thông tin cá
...
lối vào nhanh tới Cài đặt [SoT: 01-rd/req/identity.md — F1-09].

## 2. Nguồn yêu cầu (không lặp lại — chỉ trỏ)

| Hành vi | Mã | Nguồn |
| :--- | :--- | :--- |
| Sửa thông tin cá nhân | F1-09 | `01-rd/req/identity.md` — F1-09 (`[SoT: Suy luận]`) |
| Given-When-Then liên quan | — | `01-rd/req/user_stories/a1_student.md` (`US-A1-05`, GWT thứ 3) |
...
2. **Thông tin cá nhân** (6 trường, dòng 214-221): Họ và tên, Email, Trường/công ty, Vai trò hiện tại, Ngôn
   ...
   Khớp F1-09 (sửa thông tin cá nhân) nhưng cụ thể hoá 6 trường mà `identity.md` chưa liệt kê tên nào — xem Câu
   hỏi mở Q1.
...
4. **Khối "Tài khoản"** (sidebar) — Mã người dùng, Ngày tham gia, Gói (`Pro`), Quyền (`Người học`) (dòng
   ...
   tới ở bất kỳ đâu trong `README.md`/`identity.md` — xem Câu hỏi mở Q2.
...
| :-: | :--- | :--- | :--- |
| Q1 | F1-09 chưa liệt kê 6 trường cụ thể; mục Bảo mật (đổi mật khẩu tự chọn, 2FA) chưa có mã. | **6 trường đã liệt kê vào F1-09** (`identity.md`). **Đổi mật khẩu tự chọn → F1-19** (mới, đã ghi vào `identity.md`/`user_stories/a1_student.md`). **2FA nằm ngoài phạm vi đồ án** — bỏ khỏi giao diện thật, không đặc tả trong BD. | 2FA đánh dấu **[Đợi nextjs]** (xoá khối UI khi dựng thật). |
