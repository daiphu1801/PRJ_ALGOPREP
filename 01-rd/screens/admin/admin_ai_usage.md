...
> Slug: `admin_ai_usage` — khớp `01-rd/overview/system_survey.md` mục 7.3 [SoT: 01-rd/overview/system_survey.md:533].
> Bounded Context: `ai-review` (F5) [SoT: 01-rd/overview/system_survey.md:533]. Actor: A3.
>
