...
> Slug: `admin_queue_monitor` — khớp `01-rd/overview/system_survey.md` mục 7.3 [SoT: 01-rd/overview/system_survey.md:529].
> Bounded Context: `judge-orchestration` (F4) [SoT: 01-rd/overview/system_survey.md:529]. Actor: A3.
>
