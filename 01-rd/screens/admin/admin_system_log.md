...
> Slug: `admin_system_log` — khớp `01-rd/overview/system_survey.md` mục 7.3 [SoT: 01-rd/overview/system_survey.md:536].
> Bounded Context: `identity` (F1) [SoT: 01-rd/overview/system_survey.md:536]. Actor: A3.
>
