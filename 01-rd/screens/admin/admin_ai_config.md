...
> Slug: `admin_ai_config` — khớp `01-rd/overview/system_survey.md` mục 7.3 [SoT: 01-rd/overview/system_survey.md:532].
> Bounded Context: `ai-review` (F5) [SoT: 01-rd/overview/system_survey.md:532]. Actor: A3.
>
